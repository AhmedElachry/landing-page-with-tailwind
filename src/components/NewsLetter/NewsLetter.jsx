...
const NewsLetter = () => {
  return (
    <div className="container mx-auto w-full ">
      <div className="  mb-[70px] sm:max-h-[400px]  relative p-[30px] pb-0 lg:pt-[60px] lg:pl-[60px] w-[90%]  mx-auto flex justify-between flex-col lg:flex-row bg-section1-bg   rounded-2xl">
        ...
        <div className="flex relative  min-w-[353px] ">
          <img
            className="hidden absolute lg:block right-[-10px] xl:right-[-90px] bottom-[-50px] "
            src={NewsEx1}
          />
          <div className=" ">
            <img
              className="absolute hidden lg:block right-[85px]  top-[-130px]"
              src={NewsEx2}
            />
            <img
